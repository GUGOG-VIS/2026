...
::: {.organizer}
**Harriet Mason** (AFFILIATION TBC) is a researcher working on uncertainty visualization and statistical graphics. She is a co-author of the ggdibbler R package for adding uncertainty to data visualisations.
:::

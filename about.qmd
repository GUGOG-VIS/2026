...
GUGOG is co-organized with the [Munich Center for Machine Learning (MCML)](https://mcml.ai), the joint AI research center of LMU Munich and TU Munich, which also supports the workshop.

::: {layout="[1,4]" .organizer}
![](profile-media/cynthia-huang.jpg){.profile-photo fig-alt="Cynthia Huang"}
...
::: {layout="[1,4]" .organizer}
![](profile-media/matthew-kay.jpg){.profile-photo fig-alt="Matthew Kay"}
...
::: {layout="[1,4]" .organizer}
![](profile-media/susan-vanderplas.jpg){.profile-photo fig-alt="Susan Vanderplas"}
...
::: {layout="[1,4]" .organizer}
![](profile-media/heike-hofmann.jpg){.profile-photo fig-alt="Heike Hofmann"}
...
The program committee supports the organizing committee with submission review, session programming, and facilitation on the day.

::: {.organizer}
**Cynthia Huang** (LMU Munich) serves as program chair. See her organizer biography above.
:::

::: {layout="[1,4]" .organizer}
![](profile-media/harriet-mason.jpg){.profile-photo fig-alt="Harriet Mason"}

**Harriet Mason** is a Postdoctoral Research Fellow working at the intersection of visualisation, statistics, and environmental science at the University of Queensland, Australia. Her research focuses on developing new theory and tools for visualisation and often results in research software, including the cassowaryr and ggdibbler R packages.
:::

::: {layout="[1,4]" .organizer}
![](profile-media/sherry-zhang.jpeg){.profile-photo fig-alt="Sherry Zhang"}

**Sherry Zhang** is a Postdoctoral Fellow in the Department of Statistics and Data Science at the University of Texas at Austin. Her research focuses on developing method, visualization, and software tools that support exploratory data analysis. She is the author of the cubble R package, which won the 2024 ASA John M. Chambers Statistical Software Award.
:::

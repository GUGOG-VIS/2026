...
GUGOG is co-organized with the [Munich Center for Machine Learning (MCML)](https://mcml.ai).
:::
...
## Co-organizer and Support {#support}

::: {.sponsor}
[![Munich Center for Machine Learning](sponsor-media/mcml-logo.svg){.sponsor-logo fig-alt="Munich Center for Machine Learning (MCML) logo"}](https://mcml.ai)

The **[Munich Center for Machine Learning (MCML)](https://mcml.ai)** is a
co-organizer of GUGOG and supports the workshop. MCML is the joint AI research
center of LMU Munich and TU Munich, and one of six national AI Competence
Centers in Germany, funded by the German Federal Ministry of Research,
Technology and Space and the Free State of Bavaria.
:::
